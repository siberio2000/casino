            ...
            <Form>
              ...
              >
                <Col xs={12}  className="d-flex flex-row g-0">
                  <Button className={styles.roundbutton} onClick={(e) => setValue(e.target.value = '0')}>Min</Button>
                  <RangeSlider
                    value={value}
                    onChange={(e) => setValue(e.target.value)}
                  />
                   <Button className={styles.roundbutton} onClick={(e) => setValue(e.target.value = '100')}>Max</Button>
                </Col>
